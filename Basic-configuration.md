...
For a detailed walkthrough of all options available in the administration panel, see the [Settings](Settings.md) page. For a recommended step-by-step post-installation configuration sequence, see **[First steps after installation](First-steps-after-installation.md)**.
