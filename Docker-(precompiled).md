...
> [!TIP]
> **Next Step:** After completing the wizard, see **[First steps after installation](First-steps-after-installation.md)** for the step-by-step roadmap to configure participant pools, custom fields, email templates, and financial settings.
...
Proceed directly to the **[First steps after installation](First-steps-after-installation.md)** checklist to configure participant pools, profile questionnaires, notification templates, and lab parameters in the Site Settings.
