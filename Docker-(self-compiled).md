...
After initial launch and administrator creation, follow the **[First steps after installation](First-steps-after-installation.md)** checklist to configure participant pools, custom fields, notification templates, and finance settings in the Site Settings web UI.
