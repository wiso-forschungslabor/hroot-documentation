...
0. **[System Requirements and Prerequisites](System-Requirements-and-Prerequisites.md)**: Hardware, network/DNS, SMTP/IMAP mail setup, and unprivileged user permissions checklist.
...
## Next Steps: Post-Installation Setup

> [!TIP]
> **Finished the basic installation?**  
> Follow the **[First steps after installation](First-steps-after-installation.md)** checklist for a guided, step-by-step walkthrough on configuring participant pools, custom fields, message templates, finance/payment types, and staff permissions in the Site Settings.

---

## Initial Configuration & Administration

* **[First steps after installation](First-steps-after-installation.md)**: Step-by-step post-installation configuration roadmap.
