...
Once the web server is operational and your initial administrator account is created, proceed to the **[First steps after installation](First-steps-after-installation)** guide to configure participant pools, profile fields, communication templates, and lab parameters.
