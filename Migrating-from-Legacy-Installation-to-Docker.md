...
3. In the sidebar under **Database Status & Diagnostics**:
   * Click **„Test Connection“** to confirm database connectivity.
   * Click **„Initialize DB / Run Migrations“** — HROOT will automatically apply all missing v4.0 schema migrations (survey completion links, push subscriptions, staff roles) to your restored database without overwriting existing experiment and participant data.
4. Test outbound email delivery using **„Send Test E-Mail“**.
5. Click **„Save Configuration & Complete Setup“**.
